// =====================================================================
// FELIPINHO LAUNCHER - Model: Viagens
// =====================================================================
      ...
      if ((status || 'agendada') === 'em_andamento') {
        ...
        await conexao.query(
          ...
          [
            numeroNF,
            resultado.insertId,
            dados.motorista_nome || 'FELIPINHO LAUNCHER',
            dados.carga || 'Carga geral',
            dados.valor_frete || 0,
            'Nota fiscal gerada automaticamente pelo Launcher FELIPINHO LAUNCHER ao iniciar a viagem.'
          ]
        );
      }
