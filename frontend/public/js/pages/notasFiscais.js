// =====================================================================
// GR EXPRESSO - Página: Notas Fiscais (CRUD + visualização do documento)
// =====================================================================
    ...
    <div class="nota-documento animate__animated animate__fadeIn">
      ...
      <div class="nf-danfe-header">
        <div class="nf-danfe-emitente">
          <div class="nf-danfe-logo-wrap">
            <img src="img/logo/logo-gr-expresso.png" alt="GR EXPRESSO" class="nf-danfe-logo">
          </div>
          <div class="nf-danfe-emitente-info">
            <div class="nf-danfe-emitente-nome">GR EXPRESSO TRANSPORTES LTDA</div>
      ...
      <div class="nf-rodape">
        ...
        <div class="nf-rodape-col" style="text-align:right">
          ...
          <div class="nf-valor" style="font-size:0.8rem">GR EXPRESSO TRANSPORTES LTDA</div>
