// =====================================================================
// FELIPINHO LAUNCHER - Página: Viagens (CRUD + controle de status)
// =====================================================================
...
(async function () {
  ...
  if (!AuthService.ehAdmin()) {
    ...
    aviso.innerHTML = `
      <div style="
        background: linear-gradient(135deg, rgba(0, 0, 0,0.06) 0%, rgba(212, 160, 23,0.06) 100%);
