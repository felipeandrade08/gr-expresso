// =====================================================================
// FELIPINHO LAUNCHER - Página: Dashboard
    ...
    data: {
      ...
      datasets: [{
        ...
        backgroundColor: (context) => {
          ...
          if (!chartArea) return 'rgba(212, 160, 23,0.15)';
          const gradiente = c.createLinearGradient(0, chartArea.top, 0, chartArea.bottom);
          gradiente.addColorStop(0, 'rgba(212, 160, 23,0.35)');
          gradiente.addColorStop(1, 'rgba(212, 160, 23,0.02)');
          return gradiente;
        },
        borderWidth: 2.5,
...
function renderizarGraficoViagensStatus(dados) {
  ...
  const cores = { agendada: '#FFB020', em_andamento: '#3AA6FF', concluida: '#D4A017', cancelada: '#FF4D4F' };
...
function criarItemFeedMotorista(v, i) {
  const statusCores = { concluida: '#D4A017', em_andamento: '#FFB020', agendada: '#5865F2', cancelada: '#FF4D4F' };
