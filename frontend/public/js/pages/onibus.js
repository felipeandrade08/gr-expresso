// =====================================================================
// GR EXPRESSO - Página: Ônibus (Controle de Frota de Ônibus)
...
(function () {
  ...
  function salvar() {
    ...
    if (!carro || !prefixo) {
      Swal.fire({ icon: 'warning', title: 'Atenção', text: 'Modelo e prefixo são obrigatórios.', confirmButtonColor: '#0B3D2E' });
      return;
    }
