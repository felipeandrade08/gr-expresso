// =====================================================================
// FELIPINHO LAUNCHER - Página: Relatórios Avançados
// =====================================================================
  ...
  try {
    ...
    new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [
          { label: 'Faturamento', data: dados.map((d) => d.faturamento), borderColor: '#D4A017', backgroundColor: 'rgba(212, 160, 23,0.12)', tension: 0.35, fill: true, borderWidth: 2.5 },
          ...
          { label: 'Lucro', data: dados.map((d) => d.lucro), borderColor: '#0B0B0B', backgroundColor: 'rgba(0, 0, 0,0.08)', tension: 0.35, fill: true, borderWidth: 2.5 }
        ]
      },
      options: {
        responsive: true,
