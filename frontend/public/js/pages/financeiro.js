// =====================================================================
// GR EXPRESSO - Página: Controle Financeiro (CRUD + fluxo de caixa)
// =====================================================================
  ...
  try {
    ...
    new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [
          { label: 'Entradas', data: dados.map((d) => Number(d.entradas)), backgroundColor: '#A4FF00', borderRadius: 6, maxBarThickness: 38 },
          { label: 'Saídas', data: dados.map((d) => Number(d.saidas)), backgroundColor: '#0B3D2E', borderRadius: 6, maxBarThickness: 38 }
        ]
      },
      options: {
        responsive: true,
