  ...
  return `
    <aside class="sidebar" id="sidebarPrincipal">
      <div class="sidebar-marca">
        <img src="img/logo/logo-gr-expresso.png" alt="FELIPINHO LAUNCHER" class="sidebar-marca__icone-img">
        <div class="sidebar-marca__texto">
          <span class="sidebar-marca__nome">FELIPINHO LAUNCHER</span>
          <span class="sidebar-marca__sub">ETS2 Logística</span>
        </div>
      </div>
      <nav class="sidebar-nav">${grupos}</nav>
      <div class="sidebar-rodape">
        FELIPINHO LAUNCHER v1.0 &middot; Transportadora Virtual
      </div>
    </aside>
...
function montarLayout({ paginaAtiva, titulo, subtitulo }) {
  ...
  btnPerfil?.addEventListener('click', () => {
    Swal.fire({
      ...
      text: 'Você precisará fazer login novamente para voltar a acessar o FELIPINHO LAUNCHER.',
      icon: 'question',
